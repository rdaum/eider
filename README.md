...
will evaluate other NVFP4 checkpoints when they become available.
...
acceptance. The fixed greedy probe matched every canonical target decision and
preserved recurrent state bitwise.
