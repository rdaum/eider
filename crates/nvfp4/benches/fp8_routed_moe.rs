...
use nvfp4::{
    CudaEvent, CudaGraphExec, CudaStream, DeviceBuffer, F32Matrix, Result, fill_f32_into_on_stream,
    fp8_moe_grouped_down_f32_into_on_stream, fp8_moe_grouped_gate_up_f32_into_on_stream,
    moe_silu_quantize_fp8_slots_f32_into_on_stream, moe_weighted_accumulate_slots_f32_on_stream,
...
fn repeated_const_table<T: Copy>(
