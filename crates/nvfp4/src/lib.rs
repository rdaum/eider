...
pub use kernels::non_gemm::{
    ...
    gated_delta_net_128_f32_batch_into_on_stream, gated_delta_net_128_f32_into_on_stream,
    ...
    moe_silu_quantize_slots_nvfp4_simple_scales_on_stream, moe_topk_f32_batch_into_on_stream,
    ...
    prefill_gqa_attention_f32_into, quantize_fp8_e4m3_dynamic_f32_batch_into_on_stream,
