...
pub use kernels::non_gemm::{
    ...
    bf16_linear_pair_logits_f32_into_on_stream, bf16_matrix_to_f32_into_on_stream,
    ...
    copy_row_f32_into_on_stream, dflash2_capture_f32_into_on_stream,
    dflash2_grouped_conv_f32_into_on_stream, dflash2_noncausal_attention_f32_into_on_stream,
    ...
    moe_silu_quantize_fp8_slots_f32_into_on_stream, moe_silu_quantize_slots_nvfp4_on_stream,
