...
pub use kernels::non_gemm::{
    ...
    gather_group_row_f32_into_on_stream, gather_nvfp4_grouped_gemv_ptr_tables_on_stream,
    gather_nvfp4_grouped_gemv_ptrs_on_stream, increment_u32_in_place_on_stream,
