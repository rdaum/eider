...
pub use kernels::non_gemm::{
    ...
    MropeSections, add_f32_into_on_stream, append_rows_f32_indexed_into_on_stream,
    ...
    nemotron3_mamba_state_update_f32_into_on_stream, nemotron3_sigmoid_topk_f32_into_on_stream,
    ...
    prefill_gqa_attention_f32_into, quantize_fp8_e4m3_bf16_channel_scaled_into_on_stream,
