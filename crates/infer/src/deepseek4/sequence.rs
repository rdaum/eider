...
use super::{Deepseek4SequenceCheckpoint, Deepseek4SequenceState, Deepseek4TextModel};
...
pub struct Deepseek4MtpSequence {
    pub(crate) cache_id: SequenceId,
    pub(crate) page_table: Sm12xPageTable,
    pub(crate) state: super::Deepseek4LayerSequenceState,
...
impl Deepseek4MtpSequence {
    pub(crate) fn from_admission(
        ...
        state: super::Deepseek4LayerSequenceState,
        hidden_values: usize,
    ) -> Result<Self> {
        Ok(Self {
            cache_id,
