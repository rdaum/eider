...
unsafe extern "C" {
    ...
    pub(crate) fn infer_block_fp8_f32_scale_linear_f32_on_stream(
        input: *const f32,
        weight: *const u8,
        scales: *const f32,
        output: *mut f32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_block_fp8_f32_scale_linear_pair_f32_on_stream(
        input: *const f32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_dequant_block_fp8_f32_scale_to_bf16_on_stream(
        weight: *const u8,
        scales: *const f32,
        output: *mut u16,
        rows: u32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_block_fp8_f32_scale_moe_gate_up_f32_on_stream(
        indices: *const u32,
        input: *const f32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_block_fp8_f32_scale_moe_down_f32_on_stream(
        indices: *const u32,
        inputs: *const f32,
    ...
    pub(crate) fn infer_sm12x_kv_attention_pipelined_on_stream(
        ...
        partial_output: *mut f32,
        output: *mut f32,
        softmax_stats: *mut f32,
        softmax_combined: *mut f32,
        cache_len: u32,
        max_tokens: u32,
        q_heads: u32,
        kv_heads: u32,
        ...
        pv_splits: u32,
        stream: cudaStream_t,
        aux_stream: cudaStream_t,
    ) -> cudaError_t;
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_sm12x_kv_paged_attention_pipelined_on_stream(
        query: *const f32,
        key_values: *const u8,
        key_scales: *const u8,
        key_tail: *const f32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_sm12x_kv_paged_sparse_causal_attention_rows_on_stream(
        query: *const f32,
        key_values: *const u8,
        key_scales: *const u8,
        value_values: *const u8,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_paged_fp8_rows_to_f32_on_stream(
        pages: *const u8,
        row_offsets: *const u32,
        output: *mut f32,
        row_count: u32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_bf16_linear_exact_rows_f32_on_stream(
        input: *const f32,
        weight: *const u16,
        logits: *mut f32,
        batch_size: u32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_qwen38_qsa_select_appended_rows_on_stream(
        projection: *const f32,
        q_norm: *const f32,
        k_norm: *const f32,
    ...
    #[cfg(not(feature = "cuda-oxide"))]
    pub(crate) fn infer_qwen38_qsa_append_keys_on_stream(
        projection: *const f32,
        key_pool_bf16: *mut u16,
        slot: u32,
        page_offset: u32,
