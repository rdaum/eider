//! CUDA support for NVIDIA NVFP4 tensors on DGX Spark.
//!
...
pub use kernels::deepseek4::{
    ...
    gather_sorted_route_rows_f32_into_on_stream, hyper_apply_f32_batch_into_on_stream,
...
pub use kernels::non_gemm::{
    ...
    GroupedGemvAddressTableBuffers, MoeSiluQuantizeAddressSlotBuffers, MoeSortedNvfp4Rows,
    MoeSortedRoutes, MropeSections, add_f32_into_on_stream, add_f32_prefix_into_on_stream,
    append_ragged_kv_f32_into_on_stream, append_ragged_paged_kv_f32_into_on_stream,
    ...
    bf16_linear_argmax_f32_into_on_stream, bf16_linear_exact_rows_f32_into_on_stream,
    ...
    gather_nvfp4_grouped_gemv_addresses_on_stream, gelu_tanh_f32_into_on_stream,
    gelu_tanh_mul_f32_into_on_stream, gelu_tanh_mul_halves_f32_into_on_stream,
    ...
    ling3_kda_prep_chunks_into_on_stream, ling3_kda_prep_into_on_stream,
    ling3_kda_prep_rows_into_on_stream, ling3_mla_attention_f32_into_on_stream,
    ...
    ling3_mla_split_kv_a_f32_batch_into_on_stream, ling3_sigmoid_gated_rms_norm_f32_into_on_stream,
    lm_head_top1_f32_batch_into_on_stream, lm_head_top1_f32_into_on_stream,
    mask_logits_f32_batch_in_place_on_stream, moe_silu_quantize_fp8_slots_f32_into_on_stream,
    moe_silu_quantize_slots_nvfp4_simple_scale_addresses_on_stream,
    moe_topk_f32_batch_into_on_stream, moe_topk_f32_into_on_stream,
    ...
    pack_tree_kv_bf16_into_on_stream, pack_value_heads_bf16_into_on_stream,
    prefill_gqa_attention_f32_into, prefill_gqa_attention_f32_into_on_stream,
    prepend_u32_rows_into_on_stream, quantize_fp8_e4m3_bf16_channel_scaled_into_on_stream,
    ...
    qwen36_ffn_finalize_routed_batch_addresses_f32_into_on_stream,
    qwen36_full_attn_prep_f32_batch_into_on_stream, qwen36_full_attn_prep_f32_into_on_stream,
    qwen36_gdn_gate_batch_bf16_into_on_stream, qwen36_gdn_gate_batch_into_on_stream,
    qwen36_gdn_gate_into_on_stream, qwen36_gdn_gate_paired_batch_bf16_into_on_stream,
    qwen36_gdn_gate_paired_batch_into_on_stream, qwen36_gdn_prep_batch_into_on_stream,
    qwen36_gdn_prep_chunks_bf16_into_on_stream, qwen36_gdn_prep_chunks_into_on_stream,
    qwen36_gdn_prep_into_on_stream, ragged_gqa_attention_f32_into_on_stream,
    ragged_paged_gqa_attention_f32_into_on_stream, record_expert_indices_prefix_u64_on_stream,
    ...
    remap_expert_indices_range_into_on_stream, repeat_row_address_table_f32_into_on_stream,
    ...
    rope_neox_partial_f32_into_on_stream, rope_neox_partial_sequence_f32_into_on_stream,
    ...
    sigmoid_mul_f32_prefix_into_on_stream, sigmoid_scale_heads_f32_into_on_stream,
    sigmoid_scale_heads_f32_prefix_into_on_stream, sigmoid_scale_scalar_f32_into_on_stream,
...
pub use kernels::qwen38::{
    ...
    qwen38_ple_conv_update_batch_f32_into_on_stream, qwen38_ple_conv_update_f32_into_on_stream,
...
pub use kernels::sm12x_mma::{
    ...
    gemv_row_scales_residual2_splitk_batch_on_stream, indexed_gemv_addresses_on_stream,
    indexed_grouped_gemv_addresses_on_stream, indexed_grouped_gemv_row_scales_addresses_on_stream,
    ...
    moe_silu_quantize_bf16_sorted_slots_on_stream, moe_silu_quantize_slot_addresses_on_stream,
...
pub use paged_rows::{
    PagedRowBatch, PagedRowFormat, PagedRowReadStats, PagedRowReader, PagedRowSource,
};
pub use q2::{
