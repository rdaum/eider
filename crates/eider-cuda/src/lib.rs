...
pub use kernels::non_gemm::{
    ...
    bf16_linear_two_rows_f32_into_on_stream, bf16_matrix_to_f32_into_on_stream,
    bf16_to_f32_prefix_into_on_stream, cached_gqa_attention_f32_indexed_into_on_stream,
    cached_gqa_attention_f32_into_on_stream, cached_gqa_attention_nvfp4_into_on_stream,
    causal_window_softmax_f32_in_place_on_stream, causal_window_softmax_f32_to_bf16_on_stream,
    clear_expert_counts_u64_on_stream, concat_f32_rows_into_on_stream,
