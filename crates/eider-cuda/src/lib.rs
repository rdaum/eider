...
pub use kernels::non_gemm::{
    ...
    GroupedGemvPointerBuffers, GroupedGemvPointerTableBuffers, MoeSiluQuantizeAddressSlotBuffers,
    ...
    fp8_moe_grouped_down_addresses_f32_into_on_stream, fp8_moe_grouped_down_f32_into_on_stream,
    ...
    gather_nvfp4_grouped_gemv_addresses_on_stream, gather_nvfp4_grouped_gemv_ptr_tables_on_stream,
    gather_nvfp4_grouped_gemv_ptrs_on_stream, gelu_tanh_f32_into_on_stream,
    ...
    moe_silu_quantize_slots_nvfp4_on_stream,
    moe_silu_quantize_slots_nvfp4_simple_scale_addresses_on_stream,
    moe_silu_quantize_slots_nvfp4_simple_scales_on_stream, moe_silu_slots_f32_into_on_stream,
